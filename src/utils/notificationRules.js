/**
 * Shared definitions for the automatic (rule-based) notification system (web admin).
 *
 * Mirror of the mobile `zenithapp_v2/src/constants/notificationRules.js` and the
 * Cloud Functions `functions/lib/ruleDefs.js`. Keep rule shape, defaults and
 * templating logic in sync across all three.
 *
